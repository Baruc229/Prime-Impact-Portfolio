...
const translations = {
  ...
  "index.hero.whatsapp.message.fr": { "fr": "Bonjour PIA, je souhaiterais échanger avec vous sur un projet web.", "en": "Bonjour PIA, je souhaiterais échanger avec vous sur un projet web." },
  "index.hero.whatsapp.message.en": { "fr": "Hello PIA, I would like to discuss a web project with you.", "en": "Hello PIA, I would like to discuss a web project with you." },
  ...
  "index.faq.1.a": { "fr": "Nos projets démarrent à partir de 150€ TTC pour un site vitrine. Le tarif dépend du type de projet, des fonctionnalités souhaitées et de la complexité. Nous établissons toujours un devis détaillé et gratuit avant tout engagement.", "en": "Our projects start at €150 incl. tax for a showcase site. The price depends on the type of project, desired features, and complexity. We always provide a detailed and free quote before any commitment." },
